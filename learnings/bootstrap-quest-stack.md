...
| 2. Vampire Slayer | `quest_vampire.rs2` `48250` att | +120,625 att | att 68 |
| 3. Waterfall | `quest_waterfall.rs2` `137500` att/str | +343,750 each | att 87 / str 83 / **~cb 65**. Prot melee in the dungeon. White Wolf = Taverley→Catherby **trail**, not south of z=3400. Items: rope, 6 air, 6 water, 6 earth. |
